...
>
> <b>You can also manually add `index.js` and `business.js` files to your existing project's `js/src` directory, and an `index.html` file to the `src/main/assets` directory.</b>
